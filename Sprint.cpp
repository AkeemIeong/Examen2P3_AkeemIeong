...
Sprint::Sprint(int ID_de_Sprint, string Nombre_del_Sprint, string Fecha_de_Inicio, string Fecha_de_Finalizacion, string Estado_del_sprint, int ID_de_Proyecto_Relacionado) {
